...
import { useGetAllProblemsQuery, useAddBoardRowMutation } from './BoardContainerApiSlice';
...
export default function BoardContainer() {
    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        const problem = problems?.find((p: LeetcodeProblem) => p.title === selectedProblem);
    ...
    return (
        <div className="container px-4 sm:px-6 lg:px-8 mx-auto max-w-4x1">
            ...
            <h2 className="text-lg font-semibold mb-4">Select a Problem from LeetCode</h2>
                <form onSubmit={ handleSubmit }>
                    <div className="mb-4">
                        <label className="block text-gray-700 text-sm font-bold mb-2">Problem Name</label>
                        <select
                            name="problem_name"
